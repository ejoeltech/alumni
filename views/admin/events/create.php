<div class="row">
    <div class="col-md-8 mx-auto">
        <div class="card shadow-sm mt-4 border-primary border-top border-3">
            ...
            <div class="card-body">
                <form action="/doncosa/public/admin/eventCreate" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="image" class="form-label">Event Flier / Image (Optional)</label>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="location"
                            ...
                            value="<?= $data['location']; ?>" placeholder="e.g. Virtual (Zoom) or Main Hall">
                        <div class="invalid-feedback">
                            <?= $data['location_err']; ?>
                        </div>
                    </div>
